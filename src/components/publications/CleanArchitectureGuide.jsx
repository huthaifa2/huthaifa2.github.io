...
export default function CleanArchitectureGuide() {
  return (
    <FadeIn>
      {/* Notice lg:flex-row-reverse here to alternate the layout! */}
      <div className="flex flex-col lg:flex-row-reverse items-stretch bg-white/60 dark:bg-[#24242c]/90 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden transition-colors duration-300 group">
        ...
        <div className="w-full lg:w-3/5 p-6 md:p-12 flex flex-col items-start justify-center relative z-10">
          <div className="flex items-center gap-3 mb-4 md:mb-6">
             <span className="flex items-center justify-center w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
             </span>
             <span className="text-sm font-semibold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider">Project Blueprint</span>
          </div>
        ...
        <div className="w-full lg:w-2/5 bg-gradient-to-br from-gray-50 to-gray-200/50 dark:from-[#2a2a35] dark:to-[#1e1e26] p-8 md:p-12 flex justify-center items-center relative transition-colors duration-300 min-h-[400px]">
