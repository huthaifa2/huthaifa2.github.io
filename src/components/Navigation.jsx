...
export default function Navigation({ onOpenContact }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex flex-col items-center mt-6 px-4">
      <nav className="flex items-center justify-between px-6 md:px-8 py-4 w-full max-w-4xl bg-white/70 dark:bg-[#24242c]/70 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative z-50 transition-colors duration-300">
