...
export default function MacOSPrototype() {
    ...
    <FadeIn delay={100}>
      <div className="w-full bg-gradient-to-br from-white/90 to-white/60 dark:from-[#24242c]/90 dark:to-[#1a1a28]/80 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-[2rem] md:rounded-[3rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] overflow-hidden transition-colors duration-500">
        ...
        <div className="w-full aspect-video bg-black overflow-hidden relative group">
          <video
            ref={videoRef}
            src="/images/macOS-figma/macOS_figma.mp4"
          ...
          />
          <button
            onClick={() => window.open('/images/macOS-figma/macOS_figma.mp4', '_blank')}
        ...
        <div className="p-8 md:p-12">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-6">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Figma', 'UI/UX Design', 'Prototyping', 'Motion Design', 'macOS', 'Auto Layout'].map((tool, i) => (
          ...
          <p className="text-[#1d1d1f] dark:text-gray-300 text-sm md:text-lg opacity-90 leading-relaxed font-medium transition-colors duration-500">
            A thorough macOS desktop prototype built in Figma, covering a full desktop environment with an About This Mac sheet, an animated Spotlight search overlay, a fluid Command Center panel, notification banners and widgets, a Dock with hover states, and a System Preferences window. It also includes both light and dark mode, with transitions that feel true to the real macOS experience.
          </p>
        </div>
