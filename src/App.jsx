...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-gradient-to-br dark:from-[#1e1e2f] dark:via-[#13131A] dark:to-[#0d0d12] text-[#1d1d1f] dark:text-[#f4f4f5] font-sans selection:bg-blue-200 dark:selection:bg-blue-900/60 selection:text-blue-900 dark:selection:text-blue-100 antialiased relative overflow-hidden transition-colors duration-300">
          ...
          <div id="design" className="scroll-mt-32">
            <FadeIn delay={100}>
              <div className="text-center mb-10">
                ...
                <p className="text-xl md:text-2xl text-[#86868b] dark:text-gray-400 font-medium transition-colors duration-300 max-w-4xl mx-auto">
                  A collection of visual narratives, branding, and motion graphics brought to life using Adobe Creative Cloud and Figma.
                </p>
              </div>
            </FadeIn>
            <GraphicDesignCard />
          ...
          <div id="apps" className="scroll-mt-32">
            <FadeIn>
              <div className="text-center mb-10">
                ...
                <p className="text-xl md:text-2xl text-[#86868b] dark:text-gray-400 font-medium transition-colors duration-300 max-w-4xl mx-auto">
                  High-performance mobile applications engineered with Clean Architecture, BLoC state management, and seamless backend integration.
                </p>
              </div>
            </FadeIn>
            <AppCard 
      ...
      <section id="guides" className="relative z-10 w-full max-w-6xl mx-auto px-6 pb-24 scroll-mt-32">
        <FadeIn>
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-[#1d1d1f] dark:text-white mb-6 transition-colors duration-300">Guides & Notes.</h2>
            <p className="text-xl md:text-2xl text-[#86868b] dark:text-gray-400 font-medium transition-colors duration-300 max-w-4xl mx-auto">
              A collection of guides I put together for self-use and to help others, documenting my deep dives into architecture and theming.
            </p>
          </div>
        </FadeIn>
